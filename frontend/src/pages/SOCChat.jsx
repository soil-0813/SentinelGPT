...
const QUICK_PROMPTS = [
  ...
  {
    icon: <Zap size={13} />,
    text: "What MITRE techniques were detected today?",
  },
  { icon: <Globe size={13} />, text: "Analyze the active IOCs and their risk" },
  {
    icon: <FileText size={13} />,
    text: "Recommend remediation steps for the top incident",
  },
];
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        {
          ...
          //content: res.reply ?? res.message ?? "No response.",

          content:
            typeof res.reply === "object"
              ? `
              **${res.reply.title}**

            ${res.reply.summary}

            **Risk Level:** ${res.reply.risk}
           
            **Recommended Actions:**
              ${res.reply.actions.map((a) => "- " + a).join("\n")}
`
  ...
  return (
    ...
    >
      ...
      <div className="chat-messages">
        {messages.map((msg) => (
          <div key={msg.id} className={`chat-message ${msg.role}`}>
            <div
              className={`msg-avatar ${msg.role === "user" ? "user-avatar" : "ai-avatar"}`}
            >
            ...
            <div>
              ...
              <div
                className={`msg-time ${msg.role === "user" ? "" : ""}`}
      ...
      <div className="chat-input-area">
        ...
        >
          SentinelGPT may make mistakes. Always verify conclusions with your
          team.
        </div>
      </div>
    </div>
